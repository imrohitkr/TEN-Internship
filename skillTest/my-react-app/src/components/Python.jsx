        ...
        >
          <div className="header flex items-center">
            <img
              ...
              src="https://dersyb7nfifdf.cloudfront.net/production/17900/eeb83b03-94e6-4c84-a542-d2c8d8230f7d.png"
              alt="Python"
            />
          ...
          <div className="moreInfoWrapper mt-4">
            ...
            <div className="mt-2">
              <span className="moreInfo font-bold">717+:</span>
              <span className="moreInfo"> candidates assessed</span>
            </div>
            <div className="mt-2">
              <span className="moreInfo font-bold">74:</span>
