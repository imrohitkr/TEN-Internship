function Node() {
  return (
    <>
      <div className="flex flex-col md:flex-row md:gap-8 px-4 md:px-28">
        <div className="w-full md:w-1/3 mt-12 bg-gray-100 shadow-md">
          <a
          ...
          >
            <div className="header flex items-center">
              <img
                ...
                src="https://dersyb7nfifdf.cloudfront.net/production/17900/b0f6058d-6057-4e73-ba5d-81adfc93a3bf.png"
                alt="MernStack"
              />
              <div className="text font-bold">MERN STACK</div>
            ...
            <div className="skillTagsContainer mt-8 flex flex-wrap gap-2">
              <div className="pb-2">
            ...
            <div className="moreInfoWrapper mt-14">
              <div>
              ...
              <div className="mt-2">
                <span className="moreInfo font-bold">1238+:</span>
                <span className="moreInfo"> candidates assessed</span>
              </div>
              <div className="mt-2">
                <span className="moreInfo font-bold">63:</span>
        ...
        <div className="w-full md:w-1/3 mt-12 bg-gray-100 shadow-md">
          ...
          >
            <div className="header flex items-center">
              <img
                className="skill-icon w-10 h-10 mr-4"
                src="https://dersyb7nfifdf.cloudfront.net/production/17900/7da5bbcd-9759-4a65-b2f5-a76408b309a5.png"
                alt="MeanStack"
              />
              <div className="text font-bold">MEAN STACK</div>
              <div className="proceedArrow ml-auto">
                <svg
                  width="28"
                  height="28"
            ...
            <div className="skillTagsContainer mt-6 flex flex-wrap gap-2">
              <div className="pb-2">
                <button className="skillTag p-2 font-semibold text-sm bg-blue-200 rounded-lg">
                  MongoDB Miscellaneous
                </button>
        ...
        <div className="w-full md:w-1/3 mt-12 bg-gray-100 shadow-md">
          ...
          >
            <div className="header flex items-center">
              <img
                className="skill-icon w-10 h-10 mr-4"
                src="https://dersyb7nfifdf.cloudfront.net/production/17900/cbc2efb7-b06e-472b-a7fd-e4013799174d.png"
                alt="Node"
              />
              <div className="text font-bold">Node</div>
              <div className="proceedArrow ml-auto">
                <svg
                  width="28"
                  height="28"
            ...
            <div className="moreInfoWrapper mt-28">
              <div>
                <span className="moreInfo font-bold">30 minutes:</span>
                <span className="moreInfo"> duration</span>
              </div>
              ...
              <div className="mt-2">
                <span className="moreInfo font-bold">864+:</span>
                <span className="moreInfo"> candidates assessed</span>
              </div>
              <div className="mt-2">
