  ...
  const data = [
   {
    ...
    {
      id: 7,
      img: "https://dersyb7nfifdf.cloudfront.net/production/17900/19753659-9e4a-44a6-912a-be743e1bd1a2.png",
      imgTitle: "MongoDB",
      skillOne: "MongoDB Miscellaneous",
      skillTwo: "MERN",
      infoOneSpan1: "30 minutes",
  ...
  return (
    <>
      <div className="flex flex-wrap justify-between gap-5">
        {records.map((items) => (
          <div key={items.id} className="w-80 relative mx-auto sm:mx-0">
            <div
      ...
      <div className="mt-10 flex items-center justify-center gap-5">
        <button
          className="bg-gray-300 px-5 rounded-full"
          onClick={() => prePage()}
        >
          {" "}
          prev{" "}
